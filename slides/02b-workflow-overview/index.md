...
<!-- 5 workflow steps - all appear on single click -->
<div :class="$clicks >= 1 ? 'opacity-100' : 'opacity-0'" class="space-y-2 transition-opacity duration-300">
  <div class="bg-white border-gray-400 border-1 rounded px-3 py-2 flex items-center gap-3">
  ...
  <div class="bg-white border-amber-500 border-1 rounded px-3 py-2 flex items-center gap-3">
